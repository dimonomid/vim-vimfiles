...
" BY DFRANK TODO: 
"  *) add good docs of added functionality to the README.md
"
" BY DFRANK: before sharing it with author, do the following:
"  *) remove this note by dfrank
"  *) look for any other occurences of "DFRANK", remove these things
"  *) remove 'call confirm' commented stuff
"  *) uncommentn 'finish' above
...
" This command undoes this reset.
...
function! <SID>AutoPairsInsCntReset()
  if g:AutoPairsUseInsertedCount
    ...
    "call confirm( "reset, was ".b:autopairs_ins_cnt__before_reset)
  endif
endfunction
...
function! <SID>AutoPairsInsCntInc(cnt)
  if g:AutoPairsUseInsertedCount
    ...
    "call confirm( "inc: ".b:autopairs_ins_cnt)
  endif
endfunction
...
function! <SID>AutoPairsInsCntDec()
  if g:AutoPairsUseInsertedCount
    ...
    "call confirm( "dec: ".b:autopairs_ins_cnt)
  endif
endfunction
...
function! AutoPairsInsCntUndoReset()
  if g:AutoPairsUseInsertedCount
    ...
    "call confirm( "undo reset: ".b:autopairs_ins_cnt)
  endif
  return ""
endfunction
...
function! AutoPairsMap(key)
  ...
  " BY DFRANK: please NOTE: I want } key to align text, so I use my own mapping,
  "            so I have to add this check here.
  if escaped_key != '}'    " BY DFRANK!!!!
